...
import com.go.ohmy.dialogs.Dialogs;
import com.go.ohmy.entity.Operation;

import java.util.List;

public class BalanceActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, Dialogs.DialogInteractionListener.BalanceViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.go.ohmy.R.layout.activity_balance);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialogs.newOperationDialog(BalanceActivity.this, BalanceActivity.this).show();
            }
        });
        ...
        balanceViewModel.getAllOperations().observe(this, new Observer<List<Operation>>() {
            @Override
    ...
    public void onNewOperation(Operation operation) {
       balanceViewModel.insert(operation);
    }
}
